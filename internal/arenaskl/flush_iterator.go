...
import "github.com/zuoyebang/bitaloslog/internal/base"
...
func (it *flushIterator) SeekGE(key []byte) (*base.InternalKey, []byte) {
	panic("bitaloslog: SeekGE unimplemented")
}

func (it *flushIterator) SeekPrefixGE(
	prefix, key []byte, trySeekUsingNext bool,
) (*base.InternalKey, []byte) {
	panic("bitaloslog: SeekPrefixGE unimplemented")
}

func (it *flushIterator) SeekLT(key []byte) (*base.InternalKey, []byte) {
	panic("bitaloslog: SeekLT unimplemented")
}
...
func (it *flushIterator) Prev() (*base.InternalKey, []byte) {
	panic("bitaloslog: Prev unimplemented")
}
