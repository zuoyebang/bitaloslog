...
func TestSeqnum(t *testing.T) {
	...
	add(base.MakeInternalKey([]byte("key1"), 1, base.InternalKeyKindSet), makeValue(1))
	add(base.MakeInternalKey([]byte("key12"), 3, base.InternalKeyKindSet), makeValue(123))
	add(base.MakeInternalKey([]byte("key1"), 2, base.InternalKeyKindSet), makeValue(2))
	add(base.MakeInternalKey([]byte("key12"), 2, base.InternalKeyKindSet), makeValue(122))
	add(base.MakeInternalKey([]byte("key1"), 3, base.InternalKeyKindSet), makeValue(3))
	add(base.MakeInternalKey([]byte("key12"), 1, base.InternalKeyKindSet), makeValue(121))
