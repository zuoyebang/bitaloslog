...
var (
	ErrNotFound                 = errors.New("bitaloslog: not found")
	ErrFileFull                 = errors.New("bitaloslog: panic vt file full")
	...
	ErrVTBusy                   = errors.New("bitaloslog: vector table busy")
	ErrVTFull                   = errors.New("bitaloslog: panic rehash failed vector table full")
	...
	ErrCorruptedBatch           = errors.New("corrupted batch")
	ErrCorruptManifest          = errors.New("corrupted manifest")
