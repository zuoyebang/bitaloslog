...
import (
	...
	"github.com/zuoyebang/bitaloslog/internal/rawalloc"
)
...
var ErrInvalidBatch = errors.New("bitaloslog: invalid batch")
...
func (b *Batch) PrefixDeleteKeySet(key []byte, _ *WriteOptions) error {
